...
export default async function CancelConfirmPage({ params, searchParams }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-bg flex flex-col items-center justify-center px-6 py-16 text-center">
      ...
      <form action="/api/booking/cancel" method="POST" className="flex flex-col gap-3 w-full max-w-sm">
